...
Architectures](https://docs.microsoft.com/azure/guidance/guidance-architecture).
...
<a href="https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FGarrettJudd%2Freference-architectures%2Fmaster%2Fcompliance%2Fuk-official%2Fthree-tier-web-with-adds%2Ftemplates%2Fvirtualnetwork.azuredeploy.json" target="_blank">
...
Further best practice information and recommendations for configuring and securing a multi-tier application in Azure can be found in
 [Running Windows VMs for an N-tier architecture on Azure](https://docs.microsoft.com/azure/guidance/guidance-compute-n-tier-vm).
...
security](https://docs.microsoft.com/azure/best-practices-network-security).
